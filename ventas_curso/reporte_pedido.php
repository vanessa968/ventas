  ...
  <tbody>
    <tr>
      ...
      <th width="16%" bgcolor="#317eac"><span class="Estilo11">FECHA PEDIDO </span></th>
       <th width="16%" bgcolor="#317eac"><span class="Estilo11">Total Compra Pedido</span></th>
      </tr>
        <?php
    ...
    <tr class="even_row">
      ...
      <td style="text-align: center"><span class=""><?php echo $pedidos[$i]["Total_pedido"];?></span></td>
